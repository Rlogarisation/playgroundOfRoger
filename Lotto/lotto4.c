...
int counterForSorting = 0;
            ...
            while (counterForSorting < counterForColumn) {
                if (array[counterForRow][counterForSorting] > array[counterForRow][counterForSorting + 1]) {
                    TemporaryStorage = array[counterForRow][counterForSorting];
                    array[counterForRow][counterForSorting] = array[counterForRow][counterForSorting + 1];
                    array[counterForRow][counterForSorting + 1] = TemporaryStorage;
                }
                counterForSorting ++;
            }
*/